<template>
  <div class="m-5">
    ...
    <div class="container-questions-libelle">
      <button type="button" class="btn btn-outline-primary btn-grey btn-sm creer-question"
      ...
      <div class="all-questions d-flex" v-for="q in questions" v-bind:key="q.position">
        <a class="questions-libelle" @click="$emit('show-question', q.position)">
